  ...
  return (
    <div>
      ...
      <Container className='c'>
        <h1 className='titulo'>Índice de colocación de egresados en el sistema laboral.</h1>
      <hr />
      <br />
      <h2>2018-2020</h2>
      <hr />
      ...
      <tbody>
        <tr>
            <td className='titulos'>Carrera</td>
            <td className='titulos'>Nivel</td>
           
            <td className='titulos'>Numero de alumnos egresados </td>
            <td className='titulos'>Numero de alumnos que se colocaron a los 6 meses</td>
            <td className='titulos'>Índice de colocación</td>

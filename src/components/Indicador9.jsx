  ...
  return (
    <div>
      ...
      <Container className='c'>
        <h1 className='titulo'>Tasa de movilidad de estudiantes y profesores.</h1>
      <hr />
      <br />
      <h2>2018-2020</h2>
      <hr />
      ...
      <tbody>
        <tr>
            ...
            <td className='titulos'>Matricula </td>
            <td className='titulos'>Numero de alumnos que viajaron</td>
            <td className='titulos'>A que país se fueron </td>

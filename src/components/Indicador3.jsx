  ...
  return (
    <div>
        ...
        <Container className='c'>
            <h1 className='titulo'>Tasa de puntaje satisfactorio:EGETSU, EGEL.</h1>
            <br />
            <hr />
            <h1 className='titulo'>EGEL (Examen de medio termino) TSU 2022</h1>
            <br />
            <hr />
            <Row className='filas'>
                ...
                <Row>
                    <Col>
                        <Table  className='tabla' >
                            ...
                            <tbody>
                                <tr>
                                    <td className='titulos'>EGEL (Examen de medio termino) TSU 2022</td>
        ...
        <br />
        <Container className='c'>
            <h1 className='titulo'>EXANI TSU</h1>
            <br />
            <hr />
                    ...
                    <Col>
                        <Table  className='tabla' >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>* El resultado de EXANI II para alumnos que ingresan a nuestra institución no es requisito obligatorio, está determinado como un requisito deseable. </td>
        ...
        <Container className='c'>
            <h1 className='titulo'>EGEL (examen de egreso) LIC / INGENERIA  2023 </h1>
            <br />
            <hr /> 
            <Row className='filas'>
                ...
                <Row>
                    <Col>
                        <Table  className='tabla' >
                            <thead >
                                <tr>
                                    <th>Progtama educativo Licenciatura / Ingenieria</th>
                                    <th>No competente</th>
                                    <th>Competente</th>
                                    <th>Destacado</th>
                                    <th>Autonomo</th>
                            ...
                            <tbody>
                                <tr>
                                    <td className='titulos'>EGEL (examen de egreso) LIC / INGENERIA  2023</td>
                                    <td className='titulos'></td>
                                    <td className='titulos'></td>
                                    <td className='titulos'></td>
                                    <td className='titulos'></td>
        ...
        <br /><Container className='c'>
            <h1 className='titulo'>EXANI LIC / INGENERIA </h1>
            <br />
            <hr /> 
            <Row className='filas'>
                ...
                <Row>
                    <Col>
                        <Table  className='tabla' >
                            ...
                            <tbody>
                                <tr>
                                    <td className='titulos'>EXANI LIC / INGENERIA  </td>
                                    <td className='titulos'>700-800</td>
                                    <td className='titulos'>801-900</td>
                                    <td className='titulos'>901-1001</td>
                                    <td className='titulos'>1001-1200</td>
                                    <td className='titulos'>1021-1300</td>

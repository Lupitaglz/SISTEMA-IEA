  ...
  return (
    <div>
      ...
      <Container className='c'>
        <h1 className='titulo'>Tasa de docentes con perfil</h1>
      <hr />
        <Row className='filas'>
      ...
      <thead >
        <tr>
            <th>Carrera</th>
            <th>Nivel</th>
            <th>Nombre del Profesor/ Docente</th>
            <th>Nombre de la Investigaión</th>
            <th>Señalar si es PA o PTC</th>
            <th>Señalar si se terminó o esta en proceso</th>
            <th>Opciones</th>
        </tr>
      </thead>
      <tbody>
